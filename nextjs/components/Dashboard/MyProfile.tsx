...
export default function MyProfile(props: { user: User }) {
  const [nameState, setNameState] = React.useState(props.user.name);
  const [emailState, setEmailState] = React.useState(props.user.email);
  const [imageState, setImageState] = React.useState(props.user.image || "");
  ...
  function cancelHandling(e: ChangeEvent<HTMLFormElement>){
    e.preventDefault()
        ...
        >
          ...
          >
            ...
            >
              ...
              <DropZone onUpload={setImageState} />
          ...
          <Divider role="presentation" /> */}
            ...
            >
              <Button variant="outlined" color="neutral" size="sm" onClick={cancelHandling}>
                Cancel
              </Button>
